...
from chrono_des_vignes.custom_validators import DataRequired, Length, DateTimeNotPast, DateTimeBefore
...
class Edition_form(FlaskForm):
    ...
    rdv_lat: FloatField= FloatField(_('form.rdvlng'), validators=[DataRequired()], default=46.54685605692591)
    rdv_lng: FloatField= FloatField(_('form.rdvlat'), validators=[DataRequired()], default=6.449900437449806)
