...
from chrono_des_vignes.models import  Event, InscriptionData, Parcours, Edition, Inscription, User
...
def generate_all_dossard(event_name: str, edition_name: str)->str|Response:
    ...
    dossard_nb = [cast(int, inscription.dossard) for inscription in edition.inscriptions.filter(Inscription.dossard.is_not(None)).all()]
    last_dossard = 1
