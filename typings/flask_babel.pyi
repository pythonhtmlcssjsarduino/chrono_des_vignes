...
@overload
def npgettext(
    context: str, singular: str, plural: str, num: int, **variables: Any
) -> str: ...

# Formatting Functions
def format_datetime(
    datetime: datetime | float | int | None = ..., format: str | None = ...
) -> str: ...
def format_date(
    datetime: datetime | float | int | None = ..., format: str | None = ...
) -> str: ...
...
def format_timedelta(
    delta: timedelta | int | float, granularity: str = ..., threshold: float = ...
) -> str: ...
